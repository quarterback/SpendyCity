import { h as head, a as attr, c as ensure_array_like, e as escape_html, s as stringify } from "../../../chunks/root.js";
import { b as base } from "../../../chunks/server.js";
import "../../../chunks/url.js";
import "@sveltejs/kit/internal/server";
import { F as FUNDS } from "../../../chunks/funds.js";
function _page($$renderer) {
  head("1ooj66h", $$renderer, ($$renderer2) => {
    $$renderer2.title(($$renderer3) => {
      $$renderer3.push(`<title>Feed — PDX Spend</title>`);
    });
  });
  $$renderer.push(`<article><header class="container fund-header"><p class="kicker">FEED · ISSUE 01</p> <h1 class="article-title">PDX Spend, Issue 01</h1> <p class="article-deck">Seven fund pages, one dashboard, one agent demo, one methodology note, one implications essay. Listed in order of publication.</p></header> <section class="container"><ul class="feed"><li class="feed-item"><p class="feed-meta">FRONT · ISSUE 01</p> <h2><a${attr("href", `${stringify(base)}/`)}>Seven voter-passed funds, quietly redrawn around their balances</a></h2> <p>The cover essay and at-a-glance hero chart for the issue.</p></li> <!--[-->`);
