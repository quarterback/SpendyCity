import { h as head, c as ensure_array_like, e as escape_html, a as attr, s as stringify } from "../../../chunks/root.js";
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    head("1mf7izu", $$renderer2, ($$renderer3) => {
      $$renderer3.title(($$renderer4) => {
        $$renderer4.push(`<title>Agent demo — PDX Spend</title>`);
      });
    });
