import { h as head, e as escape_html, s as stringify, a as attr, c as ensure_array_like, f as derived, d as attr_class } from "../../../../chunks/root.js";
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    head("1uaawvl", $$renderer2, ($$renderer3) => {
      $$renderer3.title(($$renderer4) => {
        $$renderer4.push(`<title>${escape_html(fund().name)} — PDX Spend</title>`);
      });
      $$renderer3.push(`<meta name="description"${attr("content", fund().oneLineStatus)}/>`);
    });
    ...
    $$renderer2.push(`<!--]--></ul></section> <section class="container fund-nav"><a class="nav-back"${attr("href", `${stringify(base)}/`)}>← Back to issue index</a> <a class="nav-back"${attr("href", `${stringify(base)}/dashboard/`)}>Cross-fund dashboard →</a></section></article>`);
  });
}
export {
  _page as default
