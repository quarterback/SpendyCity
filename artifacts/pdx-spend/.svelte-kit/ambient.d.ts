...
declare module '$env/static/private' {
	...
	export const PRIVATE_OBJECT_DIR: string;
	...
	export const REPLIT_ASKPASS_PID2_SESSION: string;
	export const DEFAULT_OBJECT_STORAGE_BUCKET_ID: string;
...
declare module '$env/static/public' {
	export const PUBLIC_OBJECT_SEARCH_PATHS: string;
}
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		REPLIT_ASKPASS_PID2_SESSION: string;
